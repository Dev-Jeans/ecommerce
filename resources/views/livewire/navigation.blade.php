<header class="bg-trueGray-700 sticky top-0 z-50" x-data="dropdown()">
    <div class="container flex items-center h-16 justify-between md:justify-start">
        ...
        <div class="mx-6 relative hidden md:block">
            ...
            @else
                <x-jet-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <i class="far fa-user-circle text-white text-3xl cursor-pointer"></i>
                    </x-slot>
                    <x-slot name="content">
    ...
    <nav id="navigation-menu" 
        ...
        <div class="container h-full hidden md:block">
            <div x-on:click="close()" class="grid grid-cols-4 h-full relative">
                <ul class="bg-white">
                ...
                <div class="col-span-3 bg-gray-100">
                    <x-navigation-submenu :category="$categories->first()"/>
                </div>
